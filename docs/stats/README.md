...
Interactive dashboard showing traffic analytics for [Infinite Glyphs](https://github.com/djdarcy/infinite-glyphs).
...
|--------|------|----------|
| [Badge Gist](https://gist.github.com/djdarcy/3d01e52bd0fd7a5331324774eb0de9b9) | Public | Current stats, rolling 31-day daily history |
...
**https://djdarcy.github.io/infinite-glyphs/stats/**
